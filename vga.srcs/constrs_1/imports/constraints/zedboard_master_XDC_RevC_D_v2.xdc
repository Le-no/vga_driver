...
create_clock -period 10 [get_ports clk_in];  # Command should be testet!!
...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {colors[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {colors[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {colors[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {colors[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {colors[4]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {colors[5]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {colors[6]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {colors[7]}];  # "VGA-G4"
set_property PACKAGE_PIN AA19 [get_ports {h_sync}];  # "VGA-HS"
set_property PACKAGE_PIN V20  [get_ports {colors[8]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {colors[9]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {colors[10]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {colors[11]}];  # "VGA-R4"
